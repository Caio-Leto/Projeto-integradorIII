...
public class Water_Box_Particle : MonoBehaviour
{

    public float _Force_X;
    public float _Force_Y;
    public float _Force_Z;
    // public bool forcaUp = false;
    public float forcaUpValue = 1;
    // public int controladorAdd;
    ...
    void Start()
    {
        ...
        // controladorReceived = controladorForcaParticles.controlador;
    ...
    void Update()
    {
        ...
        // if(controladorReceived){
        //     Debug.Log(controladorReceived);
        // }

        // if(controladorReceived){
        //     Add_Force(forcaUpValue);
        //     controladorForcaParticles.controlador = false;
        // }
    }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.CompareTag("Water_Particle"))
        {
